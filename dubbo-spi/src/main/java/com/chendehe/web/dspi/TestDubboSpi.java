...
public class TestDubboSpi {
    public static void main(String[] args) {
        ...
        List<Filter> filters = filterLoader.getActivateExtension(url1, new String[] {}, CommonConstants.CONSUMER);
        ...
        List<Filter> filters2 = filterLoader.getActivateExtension(url2, new String[] {}, CommonConstants.CONSUMER);
        ...
        List<Filter> filters3 = filterLoader.getActivateExtension(url1,
            new String[] {CommonConstants.REMOVE_VALUE_PREFIX + CommonConstants.DEFAULT_KEY, "filter1", "filter2"});
